...
CONTAINER_NAME=dynosam
CONTAINER_IMAGE_NAME=dynosam

### EDIT THIS TO WHEREVER YOU'RE STORING YOU DATA ###
# folder should exist before you mount it
LOCAL_DATA_FOLDER=/home/lognavbom/dynosam_datasets
LOCAL_RESULTS_FOLDER=~/results/
LOCAL_DYNO_SAM_FOLDER=/home/lognavbom/dynosam_fork_ws/src/DynOSAM/
LOCAL_THIRD_PARTY_DYNO_SAM_FOLDER=/home/lognavbom/dynosam_fork_ws/src/third_party/
